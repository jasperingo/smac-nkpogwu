...
import { findProgramsByUserId } from '@/services/program-service';

export default async function AdminUserProgramsPage(
  ...
  const programs = await findProgramsByUserId(id, resolvePaginationParams(page));

  return (
    <section className="bg-foreground p-4">
      
      <MenuList items={[ { href: `/admin/programs/create?userId=${id}`, text: 'Add program' } ]} />
      ...
      <PaginationList path={`/admin/users/${id}/programs`} pagination={programs} />
